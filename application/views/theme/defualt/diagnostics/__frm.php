<html>
	...
	<body>
		<div style="float:left"><img style="width:50px !important" src="<?php echo base_url("resources/theme/defualt/img/bc_logo.png")?>"/></div>
			<center style="color:#F17795 !important;font-size:20px;position: relative;left: -30px;">ប័ណ្ណចាក់ថ្នាំ និងសេរ៉ូម</center>
	...
	<body>
		<div style="float:left"><img style="width:50px !important" src="<?php echo $resources?>img/bc_logo.png"/></div>
			<center style="color:#F17795 !important;font-size:20px;position: relative;left: -30px;">Diode Laser</center>
	...
	<body>
		<div style="float:left"><img style="width:50px !important" src="<?php echo $resources?>img/bc_logo.png"/></div>
			<center style="color:#F17795 !important;font-size:20px;position: relative;left: -30px;">Q-Switch Laser</center>
		<div style="float:right;position: relative; color:#F17795 !important">&nbsp;</div>
		<br/><br/>
	    <div style="float:left;width:100% !important padding:0px !important; margin:0px !important">
		   	<center>
	...
	<body>
	    ...
	    <div style="float:left"><img style="width:50px !important" src="<?php echo base_url("resources/theme/defualt/img/bc_logo.png")?>"/></div>
			<center style="color:#F17795 !important;font-size:20px;position: relative;left: -30px;">ប័ណ្ណចាក់ខ្លាញ់</center>
		<div style="float:right;position: relative; color:#F17795 !important;font-size:18px"></div>
		<br/><br/>
		<div style="float:left;width:100% !important padding:0px !important; margin:0px !important">
		   	<center>
	...
	<body>
	    <div style="float:left"><img style="width:50px !important" src="<?php echo base_url("resources/theme/defualt/img/bc_logo.png")?>"/></div>
			<center style="color:#F17795 !important;font-size:20px;position: relative;left: -30px;">CPL Laser</center>
		<div style="float:right;position: relative; color:#F17795 !important">&nbsp;</div>
		<br/><br/>
		<div style="float:left;width:100% !important padding:0px !important; margin:0px !important">
		   	<center>
	...
	<body>
	    <div style="float:left"><img style="width:50px !important" src="<?php echo base_url("resources/theme/defualt/img/bc_logo.png")?>"/></div>
			<center style="color:#F17795 !important;font-size:20px;position: relative;left: -30px;">Erbium Vag Laser</center>
		<div style="float:right;position: relative;color:#F17795 !important ">&nbsp;</div>
		<br/><br/>
		<div style="float:left;width:100% !important padding:0px !important; margin:0px !important">
		   	<center>
	...
	<body>
		<div style="float:left"><img style="width:50px !important" src="<?php echo base_url("resources/theme/defualt/img/bc_logo.png")?>"/></div>
			<center style="color:#F17795 !important;font-size:20px;position: relative;left: -30px;">ប័ណ្ណភៀសមុខ (Facial Peeling)</center>
		<div style="float:right;position: relative; color:#F17795 !important;font-size:18px"></div>
		<br/><br/>
		<div style="float:left;width:100% !important padding:0px !important; margin:0px !important">
		   	<center>
	...
	<body>
	    <div style="float:left"><img style="width:50px !important" src="<?php echo base_url("resources/theme/defualt/img/bc_logo.png")?>"/></div>
			<center style="color:#F17795 !important;font-size:20px;position: relative;left: -30px;">Anti Aging Treatment</center>
		<div style="float:right;position: relative; color:#F17795 !important;font-size:18px"></div>
		<br/><br/>
		<div style="float:left;width:100% !important padding:0px !important; margin:0px !important">
		   	<center>
	...
	<body>
		<div style="min-height:690px; padding-top:2px">
			<div style="float:left"><img style="width:50px !important" src="<?php echo base_url("resources/theme/defualt/img/bc_logo.png")?>"/></div>
			<center style="color:#F17795 !important;font-size:20px;position: relative;left: -30px;">មន្ទីរពេទ្យសម្ភពសោភាហ្គោល<br>Sorphear maternity hospital</center>
			<div style="float:right;position: relative;top:-54px; color:#F17795 !important;font-size:18px">វេជ្ជបញ្ជា</div>
	...
	?>
		<div style="min-height:690px; padding-top:2px">
		    <div style="float:left"><img style="width:50px !important" src="<?php echo base_url("resources/theme/defualt/img/bc_logo.png")?>"/></div>
			<center style="color:#F17795 !important;font-size:20px;position: relative;left: -30px;">មន្ទីរពេទ្យសម្ភពសោភាហ្គោល<br>Sorphear maternity hospital</center>
			<div style="float:right;position: relative;top:-54px; color:#F17795 !important;font-size:18px">សេវាកម្ម</div>
			<div style="float:left;width:100% !important padding:0px !important; margin:0px !important">
			   	<center>
			    	<div style="text-align:left;float:left;width:358px !important;">ឈ្មោះ៖ <?php echo @$pname;?></div>
			    	<div style="text-align:left;float:left;width:60px !important; ">អាយុ៖  <?php echo @$ppage;?></div>
	...
	<body>
			...
			<div style="min-height: 700px">
				<div style="float:left"><img style="width:50px !important" src="<?php echo base_url("resources/theme/defualt/img/bc_logo.png")?>"/></div>
				<center style="color:#F17795 !important;font-size:15px;position: relative;left: -30px;">មន្ទីរពេទ្យសម្ភពសោភាហ្គោល<br>Sorphear maternity hospital<br>វិក័យប័ត្រ</center>
				<div style="float:right;position: relative;top:-54px; color:#F17795 !important;font-size:18px"></div>

				<!-- <center style="color:#F17795 !important;font-size:20px;position: relative;left: -30px;">វិក័យប័ត្រ</center>
				<div style="float:right;position: relative;top:-54px; color:#F17795 !important;font-size:18px">សេវាកម្ម</div> -->
				<div style="float:left;width:100% !important padding:0px !important; margin:0px !important">
				   	<center>
				    	<div style="text-align:left;float:left;width:358px !important;">ឈ្មោះ៖ <?php echo @$pname;?></div>
