	  ...
	  <div class="panel box box-default collapsed-box">
		...
		<div class="col-sm-3">
			...
			<ul class="nav nav-pills nav-stacked">
			    <li><a href="#" id="p1" onclick="printRcp(2);"><i class="fa fa-print"></i> ប័ណ្ណ Laser </a></li>
			  <li><a href="#" id="p2" onclick="printRcp(6);"><i class="fa fa-print"></i> ប័ណ្ណ Hydroimpact </a></li>
			  <li><a href="#" id="p3" onclick="printRcp(5);"><i class="fa fa-print"></i> ប័ណ្ណបូមខ្លាញ់ </a></li>
			  <li><a href="#" id="p4" onclick="printRcp(4);"><i class="fa fa-print"></i> ប័ណ្ណ Modern Facial </a></li>
			</ul>
		      </div>
		      <!-- /.box-body -->
		    </div>
		...
		<div class="col-sm-3">
		    <div class="box box-solid">
		      <div class="box-body no-padding">
			<ul class="nav nav-pills nav-stacked">
			  <li><a href="#" id="p5" onclick="printRcp(1);"><i class="fa fa-print"></i> ប័ណ្ណចាក់ថ្នាំ </a></li>
			  <li><a href="#" id="p6" onclick="printRcp(3);"><i class="fa fa-print"></i> Skin Care </a></li>
			  <li><a href="#" id="p7" onclick="printFrm(2);"><i class="fa fa-print"></i> Diode Laser </a></li>
			  <li><a href="#" id="p8" onclick="printFrm(5);"><i class="fa fa-print"></i> CPL Laser </a></li>
			</ul>
		      </div>
		      <!-- /.box-body -->
		    </div>
		...
		<div class="col-sm-3">
		    <div class="box box-solid">
		      <div class="box-body no-padding">
			<ul class="nav nav-pills nav-stacked">
			  <li><a href="#" id="p9" onclick="printFrm(3);"><i class="fa fa-print"></i> Q-Switch Laser </a></li>
			  <li><a href="#" id="p10" onclick="printFrm(6);"><i class="fa fa-print"></i> Erbium Yag Laser </a></li>
			  <li><a href="#" id="p11" onclick="printFrm(7);"><i class="fa fa-print"></i> Facial Peeling </a></li>
...
<script>
	...
	function getVisitTime(ids){
		...
		$.each(data, function(key,value) {
		    ...
		    var htmlView = '';
		    htmlView += '<span class="handOver" title="<?php echo @$view;?>" onclick="viewOldPrescription('+value.visitors_id+');"><i class="fa fa-search action-btn primary"></i></span>&nbsp;&nbsp;';

		    startTrTd();
			setTd(i);
			setTd(value.visitors_in_date);
			if(value.visitors_leave_date == null){
			   setTd(''); 
			}else{
			    setTd(value.visitors_leave_date); 
			}
			setTd(htmlView);
		    stopTrTd();
		});
		...
		$("#visit_amount").text(" "+came.toString());
	    });
	}
	...
	function getMedicine(ids){
		...
		$.each(data, function(key,value) {
			...
			htmlView += '<td  style="text-align:center !important;">'+value.items_modified+'</td>';
	...
	function updateMedicine(ids){
		...
		$.each(data, function(key,value) {
			...
			/*var htmlView = '<tr>';
			htmlView += '<td  colspan="2" style="text-align:center;"><input type="text" id="m_form" style="text-align:center;" class="form-control" onkeyup="autoForm();" value="'+ value.items_modified +'"></td>';
			htmlView += '<td  colspan="1" style="text-align:center;"><input type="text" id="m_medicine" style="text-align:center;" class="form-control" onkeyup="autoMedicine();" value="'+ value.products_name +'"></td>';
			htmlView += '<td style="text-align:center;"><input type="text" id="mQty" value="'+ value.items_qty +'"  style="text-align:center;" class="form-control"></td>';
			htmlView += '<td style="text-align:center;"><input type="text" id="mPrice" value="'+ value.items_prices +'"  style="text-align:center;" class="form-control"></td>';
			htmlView += '<td style="text-align:center;"><input type="text" id="mDiscount" value="'+ value.items_discount +'"  style="text-align:center;" class="form-control"></td>';
			htmlView += '<td style="text-align:center;"><input type="text" id="mDoctor" style="text-align:center;" class="form-control" onkeyup="autoDoctor();" value="'+ value.name +'"></td>';
			htmlView += '<td style="text-align:center;"><input type="checkbox" id="mAm" value="'+checkChecked(value.mediacines_am)+'"></td>';
			htmlView += '<td style="text-align:center;"><input type="checkbox" id="mAf" value="'+checkChecked(value.mediacines_af)+'"></td>';
			htmlView += '<td style="text-align:center;"><input type="checkbox" id="mPm" value="'+checkChecked(value.mediacines_pm)+'"></td>';
			htmlView += '<td style="text-align:center;"><input type="checkbox" id="mNt" value="'+checkChecked(value.mediacines_nt)+'"></td>';
			...
			htmlView += '<tr>';
		    htmlView += '<td  colspan="2" style="text-align:center !important;">ពេល៖</td>';
		    htmlView += '<td  colspan="4" style="text-align:center;"><input type="text" id="mTime" value="'+value.items_time+'"  style="text-align:center;" class="form-control"></td>';
		    htmlView += '<td  colspan="2" style="text-align:center !important;">បរិយាយ៖</td>';
		    htmlView += '<td  colspan="4" style="text-align:center;"><input type="text" id="mDetail" value="'+value.items_detail+'"  style="text-align:center;" class="form-control"></td>';
			htmlView += '</tr>';
			
			*/

		    htmlView += '<tr>';
			htmlView += '<td  colspan="2" style="text-align:center !important;"><input type="text" id="m_medicine_id" style="text-align:center;display:none;" class="form-control" value="'+ value.service_items_id +'"><input type="text" id="m_form" style="text-align:center;" class="form-control" onkeyup="autoForm();" value="'+ value.items_modified +'"></td>';
			htmlView += '<td  style="text-align:center !important;"><input type="text" id="m_medicine" style="text-align:center;" class="form-control" onkeyup="autoMedicine();" value="'+ value.products_name +'"></td>';
			htmlView += '<td  style="text-align:center !important;"><input type="text" id="mQty" value="'+ value.items_qty +'"  style="text-align:center;" class="form-control"></td>';
			htmlView += '<td  style="text-align:center !important;"><input type="text" id="mPrice" value="'+ value.items_prices +'"  style="text-align:center;" class="form-control"></td>';
			htmlView += '<td  style="text-align:center !important;"><input type="text" id="mDiscount" value="'+ value.items_discount +'"  style="text-align:center;" class="form-control"></td>';
			htmlView += '<td  style="text-align:center !important;"><input type="text" id="mDoctor" style="text-align:center;" class="form-control" onkeyup="autoDoctor();" value="'+ value.name +'"></td>';
			...
			htmlView += '<td  style="text-align:center !important;">';
			    htmlView += '<span class="handOver" onclick="saveData();"><i class="fa fa-save action-btn primary"></i></span>';
			    htmlView += '<span class="handOver" title="<?php echo @$delete;?>" onclick="cancelMedicine('+ value.service_items_id +');"><i class="fa fa-trash-o action-btn danger"></i></span>';
			htmlView += '</td>';
		    htmlView += '</tr>';
	...
	function getService(ids){
		...
		$.each(data, function(key,value) {
			...
			hts += '<td colspan="2">'+ value.items_modified +'</td>';
			if(value.forms_name == null || value.forms_name == ''){
	...
	function addService(){
		var htmlView = '<tr>';
		    htmlView += '<td  colspan="1" style="text-align:center;"><input type="text" id="s_form" style="text-align:center;" class="form-control" onkeyup="autoForm();"></td>';
		    htmlView += '<td  colspan="4" style="text-align:center;"><input type="text" id="m_service" style="text-align:center;" class="form-control" onkeyup="autoService();"></td>';
		    htmlView += '<td  colspan="2" style="text-align:center;"><input type="text" id="sQty" value=""  style="text-align:center;" class="form-control"></td>';
		    htmlView += '<td  colspan="2" style="text-align:center;"><input type="text" id="sPrice" value=""  style="text-align:center;" class="form-control"></td>';
		    htmlView += '<td  colspan="1" style="text-align:center;"><input type="text" id="sDiscount" value=""  style="text-align:center;" class="form-control"></td>';
		    htmlView += '<td  colspan="2" style="text-align:center;"><input type="text" id="sDoctor" style="text-align:center;" class="form-control" onkeyup="autoDoctor();"></td>';
	...
	function addMedicine(){
		var htmlView = '<tr>';
			htmlView += '<td  colspan="2" style="text-align:center;"><input type="text" id="m_form" style="text-align:center;" class="form-control" onkeyup="autoForm();"></td>';
			htmlView += '<td  colspan="1" style="text-align:center;"><input type="text" id="m_medicine" style="text-align:center;" class="form-control" onkeyup="autoMedicine();"></td>';
			...
			htmlView += '<td style="text-align:center;"><input type="text" id="mDoctor" style="text-align:center;" class="form-control" onkeyup="autoDoctor();"></td>';
