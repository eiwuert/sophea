<html>
	...
	?>
		<div style="min-height:190px; padding-top:2px">
		    <div style="float:left"><img style="width: 78px !important;position: relative;top: -14px;" src="<?php echo base_url("resources/theme/defualt/img/bc_logo.png")?>"/></div>
			<center style="color:#2F3290 !important;font-size:15px;position: relative;left: -30px;">មន្ទីរពេទ្យសម្ភពសោភាហ្គោល<br>Sorphear maternity hospital<br></center>
            	<div style="width:100%; float:left; font-size: 9px">
						...
						<div style="width:40%; float:left; line-height: 17px">
							...
							<span><b>សាស្រ្ដាចារ្យឯកទេសសម្ភពរោគស្រ្ដី</b></span> <span><b>ប៉ិច សុធី</b></span><br>
							<span><b>ទូរស័ព្ទ</b></span> <span>097 970 0080</span>
						</div>

						<div style="width:60%; float:right; line-height: 15px; border-left:solid 1px #ccc; padding-left: 6px;">
		    ...
		    <h4><span class="fleft">Date: <?php if(date("Y", strtotime(@$appDetail)) != '1970'){
                                    ...
                                    ?> </span>
		    <br><br>
			    <div style="float:left;font-size: 10px; text-align: center">ប្រធានមន្ទីរពេទ្យ សម្ភពសោភា<br>SORPHEA MATERNITY HOSPITAL DIRECTOR</div>
			    <br><br><br>
			    <div style="float:left;font-size: 10px;line-height: 14px;position:absolute; bottom:2px">
			    	អាស័យដ្ឋាន : អាគារលេខ ៥៥​ - ៥៧​ ផ្លូវលេខ ១២៥ - ៦២<br>
