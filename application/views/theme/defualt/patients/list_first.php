			...
			<div class="box-header">
	            ...
	            <div class="box-body">
                    <div class="form-group">
                        <div class="input-group">
                          <span class="input-group-addon">
                              <input type="checkbox" id="checkNeo" class="displayChBox" onClick="checkNeoOpt()" value="1" >
                          </span>
                          <input type="text" value="Check NEO" class="form-control" disabled="disabled">
                        </div>
                    </div>
                              <div id="openNeoOpt" style="display:none; padding-left: 38px">
                                    <div class="form-group">
                                        <div class="input-group">
                                            <span class="input-group-addon">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            <span class="input-group-addon">
                                              <input type="checkbox" id="chNeoIcu" value="1">
                                            </span>
                                            <input type="text" value="Neo ICU" class="form-control" disabled="disabled">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="input-group">
            ...
            <h3 class="box-title">Adult</h3>
                    ...
                    <!----- OPD ------->
                        ...
                        <div class="form-group">
                            <div class="input-group">
                  					    <span class="input-group-addon">
                  					      <input type="checkbox" id="opd" onClick="viewOptOpd()" value="1">
                  					    </span>
                                ...
                                <div id="openOptOpd" style="display:none; padding-left: 38px">
                                    <div class="form-group">
                                        <div class="input-group">
                                            <span class="input-group-addon">
                                              <input type="checkbox" id="o_delivery_normal" value="1">
                                            </span>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            <span class="input-group-addon">
                                              <input type="checkbox" id="o_c_section" value="1">
                                            </span>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            <span class="input-group-addon">
                                              <input type="checkbox" id="o_delivery_complication" value="1">
                                            </span>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            <span class="input-group-addon">
                                              <input type="checkbox" id="o_maternity" value="1">
                                            </span>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            <span class="input-group-addon">
                                              <input type="checkbox" id="o_medicine" value="1">
                                            </span>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            <span class="input-group-addon">
                                              <input type="checkbox" id="o_gyn" value="1">
                                            </span>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            <span class="input-group-addon">
                                              <input type="checkbox" id="o_surgery" value="1">
                                            </span>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            <span class="input-group-addon">
                                              <input type="checkbox" id="o_infertility" value="1">
                                            </span>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            <span class="input-group-addon">
                                              <input type="checkbox" id="o_orl" value="1">
                                            </span>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            <span class="input-group-addon">
                                              <input type="checkbox" id="o_ent" value="1">
                                            </span>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            <span class="input-group-addon">
                                              <input type="checkbox" id="o_dermatology" value="1">
                                            </span>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            <span class="input-group-addon">
                                              <input type="checkbox" id="o_bone" value="1">
                                            </span>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            <span class="input-group-addon">
                                              <input type="checkbox" id="o_digestive" value="1">
                                            </span>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            <span class="input-group-addon">
                                              <input type="checkbox" id="o_cardiaque" value="1">
                                            </span>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            <span class="input-group-addon">
                                              <input type="checkbox" id="o_opd_others" value="1">
                                            </span>
                        ...
                        <div class="form-group">
                            <div class="input-group">
                  					    <span class="input-group-addon">
                  					      <input type="checkbox" id="ipd" onClick="viewOptIpd()" value="1" >
                  					    </span>
                                ...
                                <div id="openOptIpd" style="display:none; padding-left: 38px">
                                    <div class="form-group">
                                        <div class="input-group">
                                            <span class="input-group-addon">
                                              <input type="checkbox" id="i_maternity" value="1">
                                            </span>
                                            <input type="text" value="Maternity" class="form-control" disabled="disabled">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="input-group">
                                            <span class="input-group-addon">
                                              <input type="checkbox" id="i_medicine" value="1">
                                            </span>
                                            <input type="text" value="Medicine" class="form-control" disabled="disabled">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="input-group">
                                            <span class="input-group-addon">
                                              <input type="checkbox" id="i_gyn" value="1">
                                            </span>
                                            <input type="text" value="GYN" class="form-control" disabled="disabled">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="input-group">
                                            <span class="input-group-addon">
                                              <input type="checkbox" id="i_surgery" value="1">
                                            </span>
                                            <input type="text" value="Surgery" class="form-control" disabled="disabled">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="input-group">
                                            <span class="input-group-addon">
                                              <input type="checkbox" id="i_infertility" value="1">
                                            </span>
                                            <input type="text" value="Infertility" class="form-control" disabled="disabled">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="input-group">
                                            <span class="input-group-addon">
                                              <input type="checkbox" id="i_orl" value="1">
                                            </span>
                                            <input type="text" value="ORL" class="form-control" disabled="disabled">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="input-group">
                                            <span class="input-group-addon">
                                              <input type="checkbox" id="i_ent" value="1">
                                            </span>
                                            <input type="text" value="ENT" class="form-control" disabled="disabled">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="input-group">
                                            <span class="input-group-addon">
                                              <input type="checkbox" id="i_dermatology" value="1">
                                            </span>
                                            <input type="text" value="Dermatology" class="form-control" disabled="disabled">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="input-group">
                                            <span class="input-group-addon">
                                              <input type="checkbox" id="i_bone" value="1">
                                            </span>
                                            <input type="text" value="Bone" class="form-control" disabled="disabled">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="input-group">
                                            <span class="input-group-addon">
                                              <input type="checkbox" id="i_digestive" value="1">
                                            </span>
                                            <input type="text" value="Digestive" class="form-control" disabled="disabled">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="input-group">
                                            <span class="input-group-addon">
                                              <input type="checkbox" id="i_cardiaque" value="1">
                                            </span>
                                            <input type="text" value="Cardiaque" class="form-control" disabled="disabled">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="input-group">
                                            <span class="input-group-addon">
                                              <input type="checkbox" id="i_ipd_others" value="1">
                                            </span>
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        <span class="input-group-addon">
                                          <input type="checkbox" id="parmacy" onClick="parmacy()" value="1">
                                        </span>
                                        <input type="text" value="Parmacy" class="form-control" disabled="disabled">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="input-group">
                                        <span class="input-group-addon">
                                          <input type="checkbox" id="echo_ovaries" onClick="echo_ovaries()" value="1">
                                        </span>
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        <span class="input-group-addon">
                                          <input type="checkbox" id="echoMaternity" onClick="echoMaternity()" value="1">
                                        </span>
                                        <input type="text" value="Echo Maternity" class="form-control" disabled="disabled">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="input-group">
                                        <span class="input-group-addon">
                                          <input type="checkbox" id="obExamine" onClick="obExamine()" value="1">
                                        </span>
                                        <input type="text" value="OB Examine" class="form-control" disabled="disabled">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        <span class="input-group-addon">
                                          <input type="checkbox" id="echoOther" onClick="echoOther()" value="1">
                                        </span>
                                        <input type="text" value="Echo Other" class="form-control" disabled="disabled">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="input-group">
                                        <span class="input-group-addon">
                                          <input type="checkbox" id="anc" onClick="anc()" value="1">
                                        </span>
                                        <input type="text" value="ANC" class="form-control" disabled="disabled">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="input-group">
                                        <span class="input-group-addon">
                                          <input type="checkbox" id="ivg" onClick="ivg()" value="1">
                                        </span>
                                        <input type="text" value="IVG" class="form-control" disabled="disabled">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        <span class="input-group-addon">
                                          <input type="checkbox" id="perine" onClick="perine()" value="1">
                                        </span>
                  ...
                  <div class="box-header">
                    <h3 class="box-title">Support Service</h3>
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        <span class="input-group-addon">
                                          <input type="checkbox" id="labo" onClick="labo()" value="1">
                                        </span>
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        <span class="input-group-addon">
                                          <input type="checkbox" id="xray" onClick="xray()" value="1">
                                        </span>
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        <span class="input-group-addon">
                                          <input type="checkbox" id="ctscan" onClick="ctscan()" value="1">
                                        </span>
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        <span class="input-group-addon">
                                          <input type="checkbox" id="anapat" onClick="anapat()" value="1">
                                        </span>
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        <span class="input-group-addon">
                                          <input type="checkbox" id="hpv" onClick="hpv()" value="1">
                                        </span>
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        <span class="input-group-addon">
                                          <input type="checkbox" id="colpo" onClick="colpo()" value="1">
                                        </span>
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        <span class="input-group-addon">
                                          <input type="checkbox" id="thinprep" onClick="thinprep()" value="1">
                                        </span>
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        <span class="input-group-addon">
                                          <input type="checkbox" id="papsmear" onClick="papsmear()" value="1">
                                        </span>
              ...
              $.post("<?php echo $base_url;?>index.php/patients/get_patient_list",{search_data: mySearch},
                  ...
                  $.each(data, function(key,value) {
                      ...
                      htmlView += '<tr ' + stRow + '>';
                          ...
                          htmlView += '<td>';
                          if(value.patient_gender !== "m"){
                              htmlView +='<a href="#" class="handOver" title="<?php echo @$neonatal;?>" onclick="patientNeo(' + value.patient_id   + ');"><i class="fa fa-child  action-btn"></i></a>&nbsp;&nbsp; ';
                          }
...
function patientNeo(ids){
    $.post("<?php echo $base_url;?>index.php/patients/patient_neo/"+ids,{patients_id: ids},function(data,status){
...
function checkNeoOpt(){
    if($("#checkNeo").is(':checked')){
        $('#openNeoOpt').css('display','block');
        $('#checkNeo').removeClass('displayChBox');
        onDisplayChBox();
    }else{
        $('#openNeoOpt').css('display','none');
        $('#checkNeo').addClass('displayChBox');
        offDisplayChBox();
    }
}
function pediaOPD(){
