	...
	<section class="content">
		<div class="row" id="form_table">
			...
			<div class="panel box box-warning">
						<div class="box-header with-border">
								<h4 class="box-title">
										<a id="DrugReportH" data-toggle="collapse" data-parent="#accordion" href="#rServ" class=""> Service Report </a>
								</h4>
						</div>
						<div id="rServ" class="panel-collapse collapse" aria-expanded="true">
									<div class="box-body">
											<div class="form-group">
													<div class="input-group"> <div class="input-group-addon"> From </div>
															<input type="text" id="rServDate1" class="form-control">
													</div>
											</div>
											<div class="form-group">
													<div class="input-group"> <div class="input-group-addon"> To </div>
															<input type="text" id="rServDate2" class="form-control">
													</div>
											</div>
											<div class="form-group">
													<div class="input-group"> <div class="input-group-addon"> Service Type </div>
															<?php echo form_dropdown('serviceType', @$dropServiceType, @$serviecTypeId,'class="form-control" id="serviceType"');?>
													</div>
											</div>
											<div class="form-group">
													<div class="input-group">
															<input type="button" id="rServRep" class="form-control btn-primary" value="មើល" onclick="serviceTypeCal();">
													</div>
											</div>
									</div>
						</div>
...
<script>
    $(document).ready(function(){
        ...
        $( "#drDate1" ).datepicker();
        $( "#drDate2" ).datepicker();
				$( "#rServDate1" ).datepicker();
        $( "#rServDate2" ).datepicker();
    });
    ...
    function serviceTypeCal(){
				var da1 = $('#rServDate1').val();
				var da2 = $('#rServDate2').val();
				var sv = $('#serviceType').val();
				$.post("<?php echo $base_url;?>index.php/reports/serviceCount",{date1: da1, date2: da2, serviceOpt: sv},function (data){
				    $('#reportView').html(data);
				});
    }
