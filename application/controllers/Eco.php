...
class Eco extends Securities {
      ...
      public function index() {
          ...
          // Check Session
            ...
            $data['totals'] = $this->VisitorModel->getCountVisitorEco();
    ...
    //   }
      ...
      function get_eco_list(){ 
          // Check Session
            ...
            $datas = $this->VisitorModel->getAllVisitorEco();
            $this->restData($datas);
      }
