...
// Define VisitorNeo Class
class VisitorNeo extends Datastructure{
	...
	function getCountVisitorNotLeave() {
		return $this->getCountWhere($this->getTblVisitorNeo(), ' visitors_status < 3 AND neonatal_id = '.$this->getNeoId());
	}
	
	// Add or Insert Visitor
	function add(){
	    if($this->getCountVisitorNotLeave() == 0){
		$this->insertData($this->getTblVisitorNeo(),$this->getArrayDatas());
	    }
	}
